...
- [Shell Bash toolbox](#shell-bash-toolbox)
  ...
  - [BASH Syntax](#bash-syntax)
    ...
    - [Conditions in bash languages](#conditions-in-bash-languages)
      ...
      - [exit  from a while loopop](#exit--from-a-while-loopop)
    ...
    - [Archive extraction (tar)\`)](#archive-extraction-tar)
      ...
      - [Extract only a subfolder of a large .tar archiveve](#extract-only-a-subfolder-of-a-large-tar-archiveve)
      - [Display the size of a subfolder/file inside a tar archive without extracting itit](#display-the-size-of-a-subfolderfile-inside-a-tar-archive-without-extracting-itit)
    ...
    - [Command sed](#command-sed)
      - [Delete the lines lying between PATTERN-1 and PATTERN-2 , excluding the lines containing these patterns (from here)\](https://nixtricks.wordpress.com/2013/01/09/sed-delete-the-lines-lying-in-between-two-patterns/))](#delete-the-lines-lying-between-pattern-1-and-pattern-2--excluding-the-lines-containing-these-patterns-from-herehttpsnixtrickswordpresscom20130109sed-delete-the-lines-lying-in-between-two-patterns)
  ...
  - [Encryption](#encryption)
    - [Encrypt/decrypt a zip file with AES encryption](#encryptdecrypt-a-zip-file-with-aes-encryption)
  - [Others](#others)
  ...
  - [PDF](#pdf)
    ...
    - [Install Settings](#install-settings)
      - [Installer un software sur /opt/ (au lieu de ur/local/) (from here)\](https://itsfoss.com/install-software-from-source-code/))](#installer-un-software-sur-opt-au-lieu-de-urlocal-from-herehttpsitsfosscominstall-software-from-source-code)
...
#### Extract only a subfolder of a large .tar archiveve
```bash
...
#### Display the size of a subfolder/file inside a tar archive without extracting itit
...
### Encrypt/decrypt a zip file with AES encryption
